...
// console.log(str.indexOf('code')); // return 6
// console.log(str.indexOf('cde'));  // returns -1, when absent
// console.log(str.indexOf('code')); // return the first index
...
const b = "pranshu";
// console.log(a + " " + b);
// console.log(a + 10 + b); // a10b
// console.log(10 + 10 + a + b); // 20ab
...
// console.log(text1.trim());  // removes leading and trailing whitespaces
// console.log(text1.trimEnd()); // removes trailing whitespaces
// console.log(text1.trimStart()); // removes leading whitespaces





const names = "pranshu, pallavi, rohit, mohit, akash";
